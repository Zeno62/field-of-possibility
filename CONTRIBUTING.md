# Contributing · Field of Possibility v5.1

The current official edition is v5.1 in Chinese and English. Both full manuscripts have passed author review.

Chinese remains the source edition. Read the [full text](whitepaper/zh-Hans/full/field-of-possibility-whitepaper-v5.1-zh-Hans.md), [English edition](whitepaper/en/full/field-of-possibility-whitepaper-v5.1-en.md), and [terminology map](glossary/translation-map.md) before proposing changes.
